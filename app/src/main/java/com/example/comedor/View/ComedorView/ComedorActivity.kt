...
class ComedorActivity : AppCompatActivity() {
    ...
    private fun setDataOnList() : ArrayList<ItemBtnGeneric>{
        val itemBtnComedores : ArrayList<ItemBtnGeneric> = ArrayList()
        itemBtnComedores.add(ItemBtnGeneric(R.drawable.ic_personal_comedor_24,"Ver Personal"))
        itemBtnComedores.add(ItemBtnGeneric(R.drawable.ic_see_comedor_24,"Ver Comedor"))
        itemBtnComedores.add(ItemBtnGeneric(R.drawable.ic_report_info_24,"Reportes"))

        itemBtnComedores.add(ItemBtnGeneric(R.drawable.ic_services_comedor_24,"Ver Servicios"))

        itemBtnComedores.add(ItemBtnGeneric(R.drawable.ic_add_consumo_24,"Registrar Consumo"))
